...
def I0_integrand_asymp(rho):
    return I0_integrand_dominant_asymp(rho)+ I0_integrand_asymp_part0(rho)\
        +I0_integrand_asymp_part1(rho)
...
def I0_asymp_val1(muF):
    rho0 = get_rho0(muF)
    leading = vR**2 * rho0**2 + a0**2
    val = rho0**3 * leading**(-5/2) * c0(rho0) * 1/drho_g0(rho0)
