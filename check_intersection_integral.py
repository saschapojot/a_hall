...
#this script checks if integral goes to constant when beta goes to infty for I120
...
mu0 = (hbar_val ** 2 / (2 * m_val)) * (rho10_val ** 2) - (m_val * vR_val ** 2) / (hbar_val ** 2) - \
...
for b_val in beta_list:
    ...
    print(f"{int(b_val):<10} | {float(sigma_Hqco_numerical):<25.5e} ")
