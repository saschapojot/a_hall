...
# --- 5. Calculate Horizontal Plane Height ---
# Height is G1 evaluated at the minimum coordinates (rho_c_n0, gamma_min_n0)
plane_height = calculate_G1(rho_c_n0, gamma_min_n0)
...
fig.update_layout(
    title=r'Combined Surfaces G0, G1 with chemical potential mu0',
    width=1200,
    height=800,
    scene=dict(
        xaxis_title='Rho (ρ)',
...
output_filename = "Combined_G0_G1_Plane_mu0.html"
